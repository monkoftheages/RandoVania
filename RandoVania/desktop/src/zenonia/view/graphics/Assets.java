...
import superjumper.Animation;
import superjumper.Settings;
...
public class Assets {
	...
	public static void load () {
		...
		bobRun = new Animation(0.2f, new TextureRegion(items, 0, 128, 32, 32), new TextureRegion(items, 32, 128, 32, 32), new TextureRegion(items, 64, 128, 32, 32), new TextureRegion(items, 96, 128, 32, 32));
